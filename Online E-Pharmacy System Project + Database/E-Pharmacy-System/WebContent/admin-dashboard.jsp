								...
								<div class="col-md-3 col-sm-3 col-xs-6 shadow p-3 mb-5">
									<div class="alert alert-default back-widget-set text-center">
										...
										<strong style="text-transform: uppercase; font-size: 15px;"><a
											href="admin-view-medicines.jsp" class="text-dark" target="_blank">Total Medicines</a></strong>
									</div>
								</div>
								<div class="col-md-3 col-sm-3 col-xs-6 shadow p-3 mb-5">
									<div class="alert alert-default back-widget-set text-center">
										...
										<strong style="text-transform: uppercase; font-size: 15px;"><a
											href="admin-manages-medicine-orders.jsp" class="text-dark" target="_blank">Total Orders</a></strong>
									</div>
								</div>
								<div class="col-md-3 col-sm-3 col-xs-6 shadow p-3 mb-5">
									<div class="alert alert-default back-widget-set text-center">
								...
								<div class="col-md-3 col-sm-3 col-xs-6 shadow p-3 mb-5">
									<div class="alert alert-default back-widget-set text-center">
										<%
											...
											ResultSet totolAmount = DatabaseConnection.getResultFromSqlQuery("select sum(medicine_total_price) from tblorder where medicine_order_status = '" +delivered+"'");
											if (totolAmount.next()) {
										...
										<h3>
											<font color="#FF9933"><span class="counter"><%=totalSale%>&nbsp;Birr</span></font>
										</h3>
										<strong style="text-transform: uppercase; font-size: 15px;"><a
							...
							<div class="row">
								<div class="col-md-3 col-sm-3 col-xs-6 shadow p-3 mb-5">
									<div class="alert alert-default back-widget-set text-center">
										<%
											...
											ResultSet todayTotalAmount = DatabaseConnection.getResultFromSqlQuery("select sum(medicine_total_price) from tblorder where date(created_at)= CURDATE() and medicine_order_status = '"+delivered+"' ");
										...
										<i class="fa fa-desktop fa-5x"></i>
										<h3>
											<font color="#FF9933"><span class="counter"><%=todaySale%>&nbsp;Birr</span></font>
										</h3>
										<strong style="text-transform: uppercase; font-size: 15px;"><a
								...
								<div class="col-md-3 col-sm-3 col-xs-6 shadow p-3 mb-5">
									<div class="alert alert-default back-widget-set text-center">
										...
										<strong style="text-transform: uppercase; font-size: 15px;"><a
											href="admin-manages-medicine-orders.jsp" class="text-dark" target="_blank">Pending Orders</a></strong>
									</div>
								</div>
								<div class="col-md-3 col-sm-3 col-xs-6 shadow p-3 mb-5">
									<div class="alert alert-default back-widget-set text-center">
										...
										<strong style="text-transform: uppercase; font-size: 15px;"><a
											href="admin-manages-medicine-orders.jsp" class="text-dark" target="_blank">In process Orders</a></strong>
									</div>
								</div>
								<div class="col-md-3 col-sm-3 col-xs-6 shadow p-3 mb-5">
									<div class="alert alert-default back-widget-set text-center">
										...
										<strong style="text-transform: uppercase; font-size: 15px;"><a
											href="admin-manages-medicine-orders.jsp" class="text-dark" target="_blank">Delivered Orders</a></strong>
									</div>
								</div>
							</div>
						</div>
