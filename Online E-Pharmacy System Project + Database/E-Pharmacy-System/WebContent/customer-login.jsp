			...
			<div class="container">
				<div class="row">
					<div class="col-md-12 mb-0">
						<a href="index.html" class="text-primary">Home</a> <span class="mx-2 mb-0">/</span> <strong
							class="text-white">Customer Login</strong>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="row">
					<div class="col-md-6 col-sm-6 col-xs-12">
						<img src="images/customer-login.jpg"
							style="width: 550px; height: 300px; border-color: green;"></img>
					</div>
					<div class="col-md-6 col-sm-6 col-xs-12" >
						<div class="panel panel-warning shadow-lg p-5 mb-5  border-primary" style="background-color: black; border-color: green;">
							...
							<div class="panel-body" >
								...
								%>
								<form action="CustomerLogin" method="post" class="text-white">
									<div class="form-group">
										<label for="uname">User Name:</label> <input type="text"
											class="form-control" style=" border-color: green;" id="uname" placeholder="Enter username"
									...
									<div class="form-group">
										<label for="vercode">Verification Code:</label> <input
											type="password" class="form-control form" id="vercode"
