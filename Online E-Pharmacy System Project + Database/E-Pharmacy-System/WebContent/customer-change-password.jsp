				...
				<div class="row">
					<div class="col-md-12 mb-0">
						<a href="index.jsp" class="text-primary">Home</a> <span class="mx-2 mb-0">/</span> <strong
							class="text-white">Change Password</strong>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="row">
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<div class="panel panel-warning shadow p-3 mb-5" style="background-color: black; border-color: green;">
							<h2 class="text-primary ">Customer Change Password</h2>
							<div class="panel-body">
								...
								%>
								<form action="CustomerChangePassword" method="post" class="text-white">
									<%
