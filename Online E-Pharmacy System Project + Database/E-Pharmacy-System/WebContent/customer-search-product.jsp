...
<body>
	<div class="site wrap" style="background-color: black; padding: 15px;">
				...
				<div class="row">
					<div class="col-md-5 mr-auto">
						<div class="border text-center">
							<img src="uploads/<%=resultset.getString("medicine_image_name")%>" alt="Image" width="100%" height="300px" class="p-5">
						</div>
					</div>
					<div class="col-md-6">
						<h2 class="text-white"><%=resultset.getString("medicine_name") %></h2>
						...
						<p>
							...
							<strong class="text-primary h4"><%=resultset.getDouble("medicine_discount_price")%>&nbsp;Birr</strong>
						</p>
						<p>
							<a href="AddProductsToCart?medicineId=<%=resultset.getString("id")%>&mrp_price=<%=resultset.getDouble("medicine_mrp_price")%>&discount_price=<%=resultset.getDouble("medicine_discount_price")%>"
