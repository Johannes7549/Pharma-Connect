				...
				<div class="row">
					<div class="col-md-12 mb-0">
						<a href="index.jsp">Home</a> <span class="mx-2 mb-0">/</span> <strong
							class="text-white">Allopathy Medicines</strong>
					</div>
				</div>
			</div>
		</div>
		<div class="site-section ">
			<div class="container">
				<div class="row  p-3 mb-5 ">
					...
					%> 
					<div class="col-sm-6 col-lg-4 shadow-lg text-center item mb-4 item-v2 p-3 bg-dark">
				...
				<div class="row pt-5 mt-5 text-center">
					<div class="col-md-12">
						<p>
							...
							All rights reserved | PharmaConnect Management System
						</p>
					</div>
				</div>
			</div>
