		...
		<div class="">
			<div class="page-title">
				<div class="title_left">
					<h4>
						<i class="fa fa-medkit"></i> Edit Medicine Details
						</h3>
				</div>
			</div>
			...
			<div class="x_panel">
				...
				<div class="x_content shadow p-3 mb-5">
					<form role="form" action="AdminEditMedicine" method="post">
						<div class="form-row">
							...
							<div class="col-md-6 col-sm-6">
								<div class="form-group">
									<label>Select Medicine Type</label> <select
										...
										<option>Auyveda Products</option>
							...
							<div class="col-md-4 col-sm-4">
								<div class="form-group">
									<label>Manufacturing Date</label> <input class="form-control"
										type="date" name="mDate" value="<%=resultset.getString("medicine_manufacturing_date")%>">
								</div>
							</div>
							<div class="col-md-4 col-sm-4">
								<div class="form-group">
									<label>Expiry Date</label> <input class="form-control"
										type="date" name="eDate" value="<%=resultset.getString("medicine_expiry_date")%>">
								</div>
							</div>
							<div class="col-md-4 col-sm-4">
								<div class="form-group">
